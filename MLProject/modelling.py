...
# ✅ Set tracking URI ke lokal folder
mlflow.set_tracking_uri("file:D:/mlflow_log")
mlflow.set_experiment("submission model")

# ✅ Ambil run aktif (MLflow CLI sudah otomatis memulai run)
...
# 💾 Simpan model ke MLflow dengan contoh input
